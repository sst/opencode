...
| [@acramsay/opencode-shield-bash](https://github.com/acramsay/opencode-shield-bash)                 | Gate bash calls through an LLM judge subagent session to allow or deny their execution              |
