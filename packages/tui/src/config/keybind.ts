...
export const Definitions = {
  ...
  sidebar_hide: keybind("none", "Hide sidebar"),
  sidebar_width_reset: keybind("none", "Reset sidebar width"),
  sidebar_width_grow: keybind("none", "Increase sidebar width"),
  sidebar_width_shrink: keybind("none", "Decrease sidebar width"),
...
export const CommandMap = {
  ...
  sidebar_hide: "session.sidebar.hide",
  sidebar_width_reset: "session.sidebar.width.reset",
  sidebar_width_grow: "session.sidebar.width.grow",
  sidebar_width_shrink: "session.sidebar.width.shrink",
